...
class SerializationTest {
	...
	void testDeserialize() throws ClassNotFoundException, IOException {
		...
		User expectedUser1 = new User(1, "Joe Blow", "jblow@gmail.com", "password");
		...
		User expectedUser2 = new User(2, "Joe Schmoe", "joe.schmoe@outlook.com", "password");
		...
		User expectedUser3 = new User(3, "Colonel Sanders", "chickenlover1890@gmail.com", "password");
		...
		User expectedUser4 = new User(4, "Ronald McDonald", "burgers4life63@outlook.com", "password");
